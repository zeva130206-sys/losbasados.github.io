...
// EVENTOS, MODALES Y AUTENTICACIÓN BASE DE DATOS
function setupEventListeners() {
    ...
    // Guardar Cambios de Perfil en Firebase y Local
    document.getElementById('formProfile').addEventListener('submit', (e) => {
        ...
        // Actualizar en Firebase si tiene un usuario registrado por ID
    ...
    formRegister.addEventListener('submit', (e) => {
        ...
        // Limpiar email para usar como clave si es necesario o generar ID nuevo
        ...
        newUserRef.set(userData, (error) => {
            if (error) {
                ...
                alert("¡Cuenta creada con éxito, causita! Ya quedaste registrado.");
            }
        });
    });

    // INICIO DE SESIÓN CONSULTANDO LA BASE DE DATOS
    formLogin.addEventListener('submit', (e) => {
        e.preventDefault();
        const emailInput = document.getElementById('loginEmail').value.trim().toLowerCase();
        const passInput = document.getElementById('loginPass').value;

        // Buscar usuario en Firebase por correo
        usersRef.orderByChild('email').equalTo(emailInput).once('value', (snapshot) => {
            ...
            if (data) {
                ...
                if (matchedUser) {
                    ...
                    alert("Contraseña incorrecta. Revisa bien tus datos.");
                }
            } else {
